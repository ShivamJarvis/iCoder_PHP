...
<div class="container my-5">
    <div class="row">
      ...
      echo  '<div class="col-sm">
        ...
        <img class="card-img-top" src="photos/'.$row['Photo'].'" alt="Card image cap">
            <div class="card-body">
                <h5 class="card-title">'.$row["Topic"].'</h5>
                <p class="card-text">'.$row['Description'].'</p>
                <a href="video_play.php?catID='.$row['ID'].'&catName='.$row['Topic'].'&videoID=1" class="btn btn-primary">Lets Learn</a>
                </div>
        </div>
